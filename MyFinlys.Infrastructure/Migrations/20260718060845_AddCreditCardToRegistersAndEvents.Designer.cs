...
namespace MyFinlys.Infrastructure.Migrations
{
    ...
    [Migration("20260718060845_AddCreditCardToRegistersAndEvents")]
    partial class AddCreditCardToRegistersAndEvents
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyFinlys.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("MyFinlys.Domain.Entities.CreditCard", "CreditCard")
                        .WithMany()
